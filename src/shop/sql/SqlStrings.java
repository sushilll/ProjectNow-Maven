...
public interface SqlStrings {
	...
	public static String getProductsByPage = "SELECT id, name, details, price, \"imageLink\" FROM products ORDER BY create_date DESC OFFSET ? LIMIT 5";
	...
	public static String insertOrder = "INSERT INTO orders(\"orderDate\", \"totalAmount\", cust_name, cust_email, cust_mobile, cust_address) VALUES(CURRENT_TIMESTAMP, ?, ?, ?, ?, ? )";
	...
	public static String addNewProduct = "INSERT INTO products(name, details, price, \"imageLink\") VALUES(?, ?, ?, ?)";
	...
	public static String getOrder_productList = "SELECT productid, quantity, price FROM order_details WHERE orderid = ?";
	public static String getOrderDetails = "SELECT \"totalAmount\", cust_name, cust_email, cust_mobile, cust_address FROM orders WHERE id = ?";
